    ...
    <div className="flex flex-col md:flex-row justify-between rounded-lg bg-gray-100 p-5">
      ...
      <div className="flex flex-col gap-3 pl-10 items-start basis-1/2">
        ...
        <div className="flex flex-row gap-3">
          ...
          {demo ? (
            <a
              className=" flex max-w-fit items-center justify-center space-x-2 rounded-full border-gray-300 bg-black px-5 py-2 text-sm text-gray-600 shadow-md transition-colors hover:border-blue-700 border-2"
              href="https://github.com/steven-tey/precedent"
              target="_blank"
            >
